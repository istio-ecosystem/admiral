...
func (dh *DestinationRuleHandler) Added(obj *v1alpha3.DestinationRule) {
	...
	====== =
	func(dh *DestinationRuleHandler) Added(ctx
	context.Context, obj * v1alpha3.DestinationRule) {
		>>>>>>> d45832e(made
		fixes
		to
		work
	...
	func(dh *DestinationRuleHandler) Updated(obj * v1alpha3.DestinationRule)
	{
		...
		====== =
		func(dh *DestinationRuleHandler) Updated(ctx
		context.Context, obj * v1alpha3.DestinationRule) {
		>>>>>>> d45832e(made
		fixes
		to
		...
		func(dh *DestinationRuleHandler) Deleted(obj * v1alpha3.DestinationRule)
		{
			...
			====== =
			func(dh *DestinationRuleHandler) Deleted(ctx
			context.Context, obj * v1alpha3.DestinationRule) {
			>>>>>>> d45832e(made
			fixes
			to
			...
			func(vh *VirtualServiceHandler) Added(obj * v1alpha3.VirtualService)
			{
				...
				====== =
				func(vh *VirtualServiceHandler) Added(ctx
				context.Context, obj * v1alpha3.VirtualService) {
				>>>>>>> d45832e(made
				fixes
				to
				work
				...
				func(vh *VirtualServiceHandler) Updated(obj * v1alpha3.VirtualService)
				{
					...
					====== =
					func(vh *VirtualServiceHandler) Updated(ctx
					context.Context, obj * v1alpha3.VirtualService) {
					>>>>>>> d45832e(made
					fixes
					to
					...
					func(vh *VirtualServiceHandler) Deleted(obj * v1alpha3.VirtualService)
					{
						...
						====== =
						func(vh *VirtualServiceHandler) Deleted(ctx
						context.Context, obj * v1alpha3.VirtualService) {
						>>>>>>> d45832e(made
						fixes
						to
						...
						func(dh *SidecarHandler) Added(context.Context, * v1alpha3.Sidecar) {
					}

						func(dh *SidecarHandler) Updated(context.Context, * v1alpha3.Sidecar) {
					}

						func(dh *SidecarHandler) Deleted(context.Context, * v1alpha3.Sidecar) {
					}

						func
						IgnoreIstioResource(exportTo[]
						string, annotations
						...
						func
						handleDestinationRuleEvent(ctx
						context.Context, obj * v1alpha3.DestinationRule, dh * DestinationRuleHandler, event
						common.Event, resourceType
						common.ResourceType) {
						...
						if len(dependentClusters) > 0 {
							...
							for _, dependentCluster := range allDependentClusters {
								...
								exist, err := rc.ServiceEntryController.IstioClient.NetworkingV1alpha3().ServiceEntries(syncNamespace).Get(ctx, basicSEName, v12.GetOptions{})
								...
								if exist == nil || err != nil {
									...
									if ok {
										...
										drServiceEntries = createSeWithDrLabels(ctx, rc, dependentCluster == clusterId, identityId, seName, &serviceEntry, &destinationRule, r.AdmiralCache.ServiceEntryAddressStore, r.AdmiralCache.ConfigMapController)
									}
								...
								if event == common.Delete {
									...
									<<<<<<< HEAD
									====== =
									err = rc.ServiceEntryController.IstioClient.NetworkingV1alpha3().ServiceEntries(syncNamespace).Delete(ctx, seName, v12.DeleteOptions{})
									if err != nil {
									...
									for _, subset := range destinationRule.Subsets {
										...
										err = rc.ServiceEntryController.IstioClient.NetworkingV1alpha3().ServiceEntries(syncNamespace).Delete(ctx, sseName, v12.DeleteOptions{})
										if err != nil {
									...
									err = rc.DestinationRuleController.IstioClient.NetworkingV1alpha3().DestinationRules(syncNamespace).Delete(ctx, localDrName, v12.DeleteOptions{})
									if err != nil {
									...
									for _seName, se := range drServiceEntries {
										existsServiceEntry, _ = rc.ServiceEntryController.IstioClient.NetworkingV1alpha3().ServiceEntries(syncNamespace).Get(ctx, _seName, v12.GetOptions{})
										...
										if newServiceEntry != nil {
											addUpdateServiceEntry(ctx, newServiceEntry, existsServiceEntry, syncNamespace, rc)
									...
									if dependentCluster == clusterId {
										...
										createDestinationRuleForLocal(ctx, rc, localDrName, localIdentityId, clusterId, &destinationRule)
									}
						...
						<<<<<<< HEAD
						func
						handleVirtualServiceEvent(obj*v1alpha3.VirtualService, vh*VirtualServiceHandler, event
						common.Event, resourceType
						common.ResourceType) error{
						====== =
						func createDestinationRuleForLocal(ctx context.Context, remoteController *RemoteController, localDrName string, identityId string, clusterId string,
						...
						existsDestinationRule, err := remoteController.DestinationRuleController.IstioClient.NetworkingV1alpha3().DestinationRules(syncNamespace).Get(ctx, localDrName, v12.GetOptions{})
						if err != nil {
						...
						addUpdateDestinationRule(ctx, newDestinationRule, existsDestinationRule, syncNamespace, remoteController)
						}
						}
						}
						...
						====== =
						rollouts, err := vh.RemoteRegistry.RemoteControllers[clusterId].RolloutController.RolloutClient.Rollouts(obj.Namespace).List(ctx, v12.ListOptions{})
						>>>>>>> d45832e (made fixes to work with go1.17)
