...
type FilterApplyConfiguration struct {
	...
	Retries *RetryApplyConfiguration `json:"retries,omitempty"`
...
func (b *FilterApplyConfiguration) WithRetries(value *RetryApplyConfiguration) *FilterApplyConfiguration {
	b.Retries = value
	return b
}
...
func (b *FilterApplyConfiguration) WithOptions(values ...string) *FilterApplyConfiguration {
	for i := range values {
