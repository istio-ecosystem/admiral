...
// RetryApplyConfiguration represents an declarative configuration of the Retry type for use
// with apply.
...
// RetryApplyConfiguration constructs an declarative configuration of the Retry type for use with
// apply.
...
func (b *RetryApplyConfiguration) WithPerTryTimeout(value string) *RetryApplyConfiguration {
