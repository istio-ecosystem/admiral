...
func (in *ClientServiceStatus) DeepCopyInto(out *ClientServiceStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientServiceStatus.
func (in *ClientServiceStatus) DeepCopy() *ClientServiceStatus {
	if in == nil {
		return nil
	}
	out := new(ClientServiceStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClientSpec) DeepCopyInto(out *ClientSpec) {
	*out = *in
	...
	if in.Http != nil {
		...
		*out = make([]ClientHttpRoute, len(*in))
		for i := range *in {
