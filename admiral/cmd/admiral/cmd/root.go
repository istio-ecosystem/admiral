...
func GetRootCmd(args []string) *cobra.Command {
	...
	rootCmd.PersistentFlags().StringVar(&params.LabelSet.AdmiralIgnoreLabel, "admiral_ignore_label", "admiral-ignore",
		"The label value, on a namespace, which tells Istio to perform sidecar injection")
	rootCmd.PersistentFlags().StringVar(&params.NameSuffix, "name_suffix", ".global",
		"Suffix to customize name generated by admiral. Default value will be \".global\"")
	rootCmd.PersistentFlags().StringVar(&params.Identifier, "identity_label", "identity",
		"Name of the label on deployment which holds identity value used to generate name by admiral. Default value will be \"identity\"")
