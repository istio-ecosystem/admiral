...
func GetRootCmd(args []string) *cobra.Command {
	...
	rootCmd.PersistentFlags().StringVar(&params.HostnameSuffix, "hostname_suffix", "local",
		"The hostname suffix to customize the cname generated by admiral. Default suffix value will be \"local\"")
